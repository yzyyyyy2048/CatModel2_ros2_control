...
package_controller = "CatModel2_v2_controller"

def launch_setup(context, *args, **kwargs):
    package_description = context.launch_configurations['pkg_description']
    pkg_path = os.path.join(get_package_share_directory(package_description))

    xacro_file = os.path.join(pkg_path, 'xacro', 'CatModel2_v2.xacro')
    ...
    motion_publisher = Node(
        package="CatModel2_v2_motion",
        executable="CatModel2_motion_command",
        name='CatModel2_motion_command',
            output='screen',
...
def generate_launch_description():
    pkg_description = DeclareLaunchArgument(
        'pkg_description',
        default_value='CatModel2_v2_description',
