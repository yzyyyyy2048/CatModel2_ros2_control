#include "CatModel2_v2_controller/CatModel2Controller.h"

#include <ocs2_core/misc/LoadData.h>
#include <ocs2_core/thread_support/ExecuteAndSleep.h>
#include <ocs2_core/thread_support/SetThreadPriority.h>
#include <CatModel2_v2_dummy/gait/GaitReceiver.h>
#include <CatModel2_v2_controller/estimator/LinearKalmanFilter.h>
#include <CatModel2_v2_controller/wbc/WeightedWbc.h>
...
namespace legged {
    ...
    controller_interface::InterfaceConfiguration CatModel2Controller::command_interface_configuration() const {
    ...
    controller_interface::CallbackReturn CatModel2Controller::on_init() {
        // Initialize OCS2
        ...
        ctrl_comp_.visualizer_ = std::make_shared<CatModel2Visualizer>(
    ...
    controller_interface::CallbackReturn CatModel2Controller::on_configure(
    ...
    controller_interface::CallbackReturn CatModel2Controller::on_activate(
        const rclcpp_lifecycle::State & /*previous_state*/) {
    ...
    controller_interface::CallbackReturn CatModel2Controller::on_deactivate(
        const rclcpp_lifecycle::State & /*previous_state*/) {
        release_interfaces();
        return CallbackReturn::SUCCESS;
    }

    controller_interface::CallbackReturn CatModel2Controller::on_cleanup(
        const rclcpp_lifecycle::State & /*previous_state*/) {
        return CallbackReturn::SUCCESS;
    }

    controller_interface::CallbackReturn CatModel2Controller::on_shutdown(
        const rclcpp_lifecycle::State & /*previous_state*/) {
        return CallbackReturn::SUCCESS;
    }

    controller_interface::CallbackReturn CatModel2Controller::on_error(
        const rclcpp_lifecycle::State & /*previous_state*/) {
        return CallbackReturn::SUCCESS;
    }
    ...
    void CatModel2Controller::setupMrt() {
    ...
    void CatModel2Controller::setupStateEstimate() {
