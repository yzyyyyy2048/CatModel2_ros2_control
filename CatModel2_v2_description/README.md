...
```bash
cd ~/ros2_ws
colcon build --packages-up-to CatModel2_v2_description --symlink-install
```
...
ros2 launch CatModel2_v2_description visualize.launch.py
```
...
* OCS2 Quadruped Controller
  ```bash
  source ~/ros2_ws/install/setup.bash
  ros2 launch CatModel2_v2_controller mujoco.launch.py
  ```
...
* RL Quadruped Controller
  ```bash
  source ~/ros2_ws/install/setup.bash
  ros2 launch CatModel2_v2_description gazebo_rl_control.launch.py
  ```
...
Open "CatModel2_v2_description.urdf" in "./CatModel2_v2_description/urdf",
