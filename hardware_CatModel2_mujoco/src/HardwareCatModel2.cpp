...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn HardwareCatModel2::on_init(
...
//在硬件接口初始化时调用
std::vector<hardware_interface::StateInterface> HardwareCatModel2::export_state_interfaces() {
...
std::vector<hardware_interface::CommandInterface> HardwareCatModel2::export_command_interfaces() {
...
void HardwareCatModel2::initLowCmd() {
...
PLUGINLIB_EXPORT_CLASS(
    HardwareCatModel2, hardware_interface::SystemInterface)
